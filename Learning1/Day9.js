...
// ```
// 30 min → LeetCode (Missing Number)
// 60 min → Higher-order functions & callbacks
// ```

// ---

// Start with the JS exercises (4 tasks). These build on closures and arrow functions you already know.

// **Day 9. Keep the streak alive.** 💪